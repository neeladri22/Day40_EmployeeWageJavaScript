...
*/
//Uc15
//Employee id & salary are non zero positive number, gender is M or F, date ois not future date
class EmployeePayRollData{
    //Properties
    id;
    salary;
...
let employeeObject1 = new EmployeePayRollData(1,'Neeladri',200000,'M',new Date());
console.log(employeeObject1.toString());
try{
    let employeeObject = new EmployeePayRollData(2,'Hemanth',200000,'S',new Date());
    console.log(employeeObject.toString());
}
catch (ex){
    console.error(ex);
    ...
    try{
        let newEmployeeObject = new EmployeePayRollData(3,'Varshith',200000,'F',new Date(2022,4,7,15,15,15,15));
        console.log(newEmployeeObject.toString());
    }
    catch (ex){
        console.error(ex);
